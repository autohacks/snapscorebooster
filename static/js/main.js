$(document).ready(function() {
    setInterval(function() {
        ...
        $(".live-stats").last().remove(), $(".activityContent").hide().prepend('<div class="live-stats"><div class="avatar"><img src="' + o + '" alt="" /></div><div class="flag"><img src="img/flags/' + n + '.png" alt="" /></div><div class="info"><ul><li><b>' + r + ',</b> generated now:</li><li><img class="item-gen" src="img/avatar.png" alt="" />Snap Score: <span class="bucks-color">' + s + "</span> </li></ul></div></div>").fadeIn()
    }, 2e3);
    var a = $(".vBucks-input");
    a.updown({
        step: 1e4,
